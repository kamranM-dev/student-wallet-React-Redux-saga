...
import './terms-and-service.scss';

export default class TermsAndService extends React.Component {

  render(){
    return (
      <div className="how-it-works container">
        <div className="text-xxxlarge text-center">
          Welcome to Student Wallet
        </div>
        <div className="how-it-works__cards">
          These terms and conditions outline the rules and regulations for the use of Student Wallet's Website.
          <br/><br/>
          By accessing this website we assume you accept these terms and conditions in full. Do not continue to use
          Student Wallet's website
          ...
          We employ the use of cookies. By using Student Wallet's website you consent to the use of cookies
          in accordance with Student Wallet’s privacy policy.Most of the modern day interactive web sites
          use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
          to enable the functionality of this area and ease of use for those people visiting. Some of our
          affiliate / advertising partners may also use cookies.License
          Unless otherwise stated, Student Wallet and/or it’s licensors own the intellectual property rights for
          all material on Student Wallet. All intellectual property rights are reserved. You may view and/or print
          pages from https://www.studentwallet.org for your own personal use subject to restrictions set in these terms
          and conditions.
          You must not:
          <br/><br/>
          Republish material from https://www.studentwallet.org
          Sell, rent or sub-license material from https://www.studentwallet.org
          Reproduce, duplicate or copy material from https://www.studentwallet.org
          <br/><br/>
          Redistribute content from Student Wallet (unless content is specifically made for redistribution).
          ...
          you must notify us by sending an e-mail to hello@studentwallet.org.
          ...
          <br/><br/>
          No use of Student Wallet’s logo or other artwork will be allowed for linking absent a trademark license
          agreement.
          Iframes
