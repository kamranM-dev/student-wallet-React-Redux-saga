    ...
    return (
      <div className="how-it-works container">
        ...
        <div className="how-it-works__cards">
          Privacy Policy of https://www.studentwallet.org
          <br/>
          <br/>
          Privacy Policy<br/>
          ...
          <br/>
          <br/>
          Student Wallet ("us", "we", or "our") operates the https://www.studentwallet.org website (hereinafter referred to as the "Service").
          <br/>
          <br/>
          This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy for Student Wallet is created with the help of the Privacy Policies website.
          <br/><br/>
          We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from https://www.studentwallet.org
          <br/><br/>
          ...
          Use of Data<br/>
          Student Wallet uses the collected data for various purposes:<br/>
          <br/><br/>
          ...
          <br/><br/>
          Student Wallet will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.
          <br/><br/>
          Disclosure Of Data<br/>
          Legal Requirements<br/>
          Student Wallet may disclose your Personal Data in the good faith belief that such action is necessary to:
          <br/><br/>
          To comply with a legal obligation<br/>
          To protect and defend the rights or property of Student Wallet<br/>
          ...
          <br/><br/>
          By email: hello@studentwallet.org
        </div>
      </div>
    );
  }
